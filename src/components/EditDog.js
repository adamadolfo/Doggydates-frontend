...
const EditDog = (props) => {
        ...
        const handleSubmit = async e => {
            ...
            const response = await fetch(`https://dogdates-api.herokuapp.com/dogs/${parseInt(id)}`, {
                method: "PATCH",
        ...
        >
            <Paper className="form-paper">
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <Button type="submit" style={{color: "white", width: "96%", margin: "10px", height: "50px", fontSize: "1.15rem"}} variant="contained" color="primary">Edit Dog</Button>
                    </form>
            </ThemeProvider>
            </Paper>
        </Grid>
